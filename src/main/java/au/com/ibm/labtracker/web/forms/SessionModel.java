package au.com.ibm.labtracker.web.forms;
...
import au.com.ibm.labtracker.config.ConfigUtil;
import au.com.ibm.labtracker.scaffold.AbstractMaintenanceForm;
import au.com.ibm.labtracker.scaffold.IMasterPersistentEntity;
import au.com.ibm.labtracker.utils.PageDetails;
...
public class SessionModel<T extends IMasterPersistentEntity> implements Serializable {
	...
	private String content = "/ui/trainingEvent/trainingEvent.xhtml";
